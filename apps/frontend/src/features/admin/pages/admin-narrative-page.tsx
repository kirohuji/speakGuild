      ...
      {!selectedPackage && (activeTab === 'studio' || activeTab === 'episodes') ? (
        <div className="space-y-4">
          ...
          {filteredPackages.length ? <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">{filteredPackages.map((item) => (
            <Card key={item.id} className="group cursor-pointer transition-all hover:-translate-y-0.5 hover:border-amber-500/35 hover:shadow-md" onClick={() => openPackage(item.id)}>
